...
LOGGING = {
    ...
    'loggers': {
        ...
        'django.server': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},  # 🔥 Affiche les requêtes HTTP
        'gunicorn.access': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},  # 🔥 Affiche les logs de Gunicorn
    },
}
